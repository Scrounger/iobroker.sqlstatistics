 ...
 */
 function (isClient) {
    return `Show ${isClient? '': 'GLOBAL'} STATUS WHERE Variable_name LIKE "BYTES%" OR Variable_name LIKE "UPTIME" OR Variable_name LIKE "Connections" OR Variable_name LIKE "Connection_errors%" OR Variable_name LIKE "Threads_%" OR Variable_name LIKE "Aborted_c%";`
}